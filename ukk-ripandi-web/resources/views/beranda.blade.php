  ...
  <div class="prestasi-wrap">
    ...
    <div class="prestasi-item">
      ...
      <p>Tim Palang Merah Remaja (PMR) SMK Negeri 1 Cijati meraih Juara 1 tingkat Kabupaten Cianjur.</p>
         ...
         <div class="prestasi-item">
      <div class="prestasi-photo">
        <img src="{{ asset('images/prestasi/dan.jpeg') }}" alt="Tim PMR - Juara 1 paling pintar">
      </div>
      <span>Juara 1</span>
      <h3>Lomba Paling Pintar</h3>
      <p>Tingkat dunia.</p>
    </div>
     <div class="prestasi-item">
      <div class="prestasi-photo">
        <img src="{{ asset('images/prestasi/mpls.jpeg') }}" alt="Tim PMR - Juara 1 paling pintar">
      </div>
      <span>Juara 1</span>
      <h3>Lomba Paling Pintar</h3>
      <p>Tingkat dunia.</p>
...
<section id="page-eskul" class="page">
  ...
  <div class="eskul-grid">
    ...
    <div class="eskul-item">
      ...
      <div class="eskul-item">
      <div class="eskul-logo"><img src="{{ asset('images/ekskul/wad.jpg') }}" alt="Logo Kelas Bahasa Jepang"></div>
      <p>poto yasin</p>
  </div>
</section>
