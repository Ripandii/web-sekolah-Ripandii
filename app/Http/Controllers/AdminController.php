...
class AdminController extends Controller
{
     ...
     * Ini yang akan tampil setelah login berhasil (resources/views/admin/admin.blade.php).
     *
    ...
    public function index()
    {
        ...
        // Dipakai untuk dropdown "Jurusan" di form Tambah/Edit Guru (kalau sudah dibuat).
        $jurusanList = $jurusan;

        return view('admin.admin', compact(
            'profil', 'beranda', 'jurusan', 'guru', 'ekskul', 'galeriVideo',
            'artikel', 'agenda', 'fasilitas', 'prestasi', 'jurusanList'
        ));
    }
}